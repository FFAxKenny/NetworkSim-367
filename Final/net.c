	...
	if(file != NULL)
	{
		...
		while(fgets(line,sizeof line, file) != NULL)
		{
			...
			if(line[0] != '-' && i > 0)
			{
				...
				linkArray->link[third].uniPipeInfo.physIdSrc = first;
				linkArray->link[third].uniPipeInfo.physIdDst = second;
			}
			i++;
		}
		fclose(file);
...
/*
	...
	linkArray->link[2].uniPipeInfo.physIdSrc = 0;
	linkArray->link[2].uniPipeInfo.physIdDst = 4;
	linkArray->link[3].uniPipeInfo.physIdSrc = 4;
	linkArray->link[3].uniPipeInfo.physIdDst = 0;
	linkArray->link[4].uniPipeInfo.physIdSrc = 0;
	linkArray->link[4].uniPipeInfo.physIdDst = 5;
	linkArray->link[5].uniPipeInfo.physIdSrc = 5;
	linkArray->link[5].uniPipeInfo.physIdDst = 0;
	linkArray->link[6].uniPipeInfo.physIdSrc = 1;
	linkArray->link[6].uniPipeInfo.physIdDst = 6;
	linkArray->link[7].uniPipeInfo.physIdSrc = 6;
	linkArray->link[7].uniPipeInfo.physIdDst = 1;
	linkArray->link[8].uniPipeInfo.physIdSrc = 1;
	linkArray->link[8].uniPipeInfo.physIdDst = 7;
	linkArray->link[9].uniPipeInfo.physIdSrc = 7;
	linkArray->link[9].uniPipeInfo.physIdDst = 1;
	linkArray->link[10].uniPipeInfo.physIdSrc = 2;
	linkArray->link[10].uniPipeInfo.physIdDst = 8;
	linkArray->link[11].uniPipeInfo.physIdSrc = 8;
	linkArray->link[11].uniPipeInfo.physIdDst = 2;
	linkArray->link[12].uniPipeInfo.physIdSrc = 0;
	linkArray->link[12].uniPipeInfo.physIdDst = 1;
	linkArray->link[13].uniPipeInfo.physIdSrc = 1;
	linkArray->link[13].uniPipeInfo.physIdDst = 0;
	linkArray->link[14].uniPipeInfo.physIdSrc = 1;
	linkArray->link[14].uniPipeInfo.physIdDst = 2;
	linkArray->link[15].uniPipeInfo.physIdSrc = 2;
	linkArray->link[15].uniPipeInfo.physIdDst = 1;
*/
	
// Host side setup
// linkArray->link[].uniPipeInfo.physIdSrc = X
// linkArray->link[].uniPipeInfo.physIdDst = SID

// Switch side setup
// linkArray->link[].uniPipeInfo.physIdSrc = SID
// linkArray->link[].uniPipeInfo.physIdDst = X
